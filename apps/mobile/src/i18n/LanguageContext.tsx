...
export const MOBILE_TRANSLATIONS: Record<Language, Record<string, string>> = {
  de: {
    ...
    new_task_desc: 'Montageaufgabe, Prüfung oder Baustellenauftrag',
    new_question: 'Frage stellen',
    new_question_desc: 'Rückfrage an Bauleiter, Planer oder Meister',
    new_revision: 'Revision erstellen',
    new_revision_desc: 'Planänderung, Umbau oder Nachtrag',
    new_fehler: 'Mangel / Fehler melden',
    new_fehler_desc: 'Ausführungsfehler, Schaden oder Abweichung',
    // Plans & Viewer
    plans_title: 'Baupläne & Geschosse',
    search_plans: 'Pläne oder Geschosse durchsuchen...',
    no_plans: 'Keine Pläne gefunden',
    expand_all: 'Alle aufklappen',
    collapse_all: 'Alle zuklappen',
    circuit_badge: 'Stromkreis',
    cable_badge: 'Kabel',
    fuse_label: 'Sicherung',
    phase_label: 'Phase',
    distribution_board: 'Verteiler (UV)',
    status_planned: 'Geplant',
    status_in_progress: 'In Bearbeitung',
    status_done: 'Fertiggestellt',
    status_reported: 'Gemeldet zur Ausführung',
  },
  pl: {
    menu: 'MENU ▾',
    admin: 'ADMIN ▾',
    ...
    new_task_desc: 'Zadanie montażowe lub pomiary',
    new_question: 'Zadaj pytanie',
    new_question_desc: 'Pytanie do kierownika lub projektanta',
    new_revision: 'Nowa rewizja',
    new_revision_desc: 'Zmiana planu lub aneks',
    new_fehler: 'Zgłoś błąd / usterkę',
    new_fehler_desc: 'Błąd montażowy, uszkodzenie lub wada',
    // Plans & Viewer
    plans_title: 'Plany Budowlane i Rzuty',
    search_plans: 'Szukaj planów lub kondygnacji...',
    no_plans: 'Nie znaleziono planów',
    expand_all: 'Rozwiń wszystkie',
    collapse_all: 'Zwiń wszystkie',
    circuit_badge: 'Obwód',
    cable_badge: 'Kabel',
    fuse_label: 'Zabezpieczenie',
    phase_label: 'Faza',
    distribution_board: 'Rozdzielnica (UV)',
    status_planned: 'Zaplanowane',
    status_in_progress: 'W trakcie',
    status_done: 'Ukończone',
    status_reported: 'Zgłoszone do wykonania',
  },
  en: {
    menu: 'MENU ▾',
    admin: 'ADMIN ▾',
    ...
    new_task_desc: 'Installation task, test or order',
    new_question: 'Ask Question',
    new_question_desc: 'Question to project manager or planner',
    new_revision: 'Create Revision',
    new_revision_desc: 'Plan change or revision',
    new_fehler: 'Report Defect / Error',
    new_fehler_desc: 'Installation defect or damage',
    // Plans & Viewer
    plans_title: 'Building Plans & Floors',
    search_plans: 'Search plans or floors...',
    no_plans: 'No plans found',
    expand_all: 'Expand All',
    collapse_all: 'Collapse All',
    circuit_badge: 'Circuit',
    cable_badge: 'Cable',
    fuse_label: 'Fuse / Protection',
    phase_label: 'Phase',
    distribution_board: 'Distribution Board (UV)',
    status_planned: 'Planned',
    status_in_progress: 'In Progress',
    status_done: 'Done',
    status_reported: 'Reported for execution',
  },
  sk: {
    menu: 'MENU ▾',
    admin: 'ADMIN ▾',
    ...
    // Quick actions
    quick_create: '+ Vytvoriť',
    create_new: 'Vytvoriť nové',
    new_task: 'Vytvoriť úlohu',
    new_task_desc: 'Montážna úloha alebo meranie',
    new_question: 'Položiť otázku',
    new_question_desc: 'Otázka na stavbyvedúceho alebo projektanta',
    new_revision: 'Vytvoriť revíziu',
    new_revision_desc: 'Zmena plánu alebo dodatok',
    new_fehler: 'Nahlásiť chybu / vadu',
    new_fehler_desc: 'Montážna chyba, poškodenie alebo vada',
    // Plans & Viewer
    plans_title: 'Stavebné plány a podlažia',
    search_plans: 'Hľadať plány alebo podlažia...',
    no_plans: 'Nenašli sa žiadne plány',
    ...
    fuse_label: 'Istenie',
    phase_label: 'Fáza',
    distribution_board: 'Rozvádzač (UV)',
    status_planned: 'Naplánované',
    status_in_progress: 'V procese',
    status_done: 'Dokončené',
    status_reported: 'Nahlásené na realizáciu',
  },
};
