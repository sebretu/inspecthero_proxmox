...
export default function ReportPdf({ projectId, projectName, projectCompanyName, planIds, statuses, dateFrom, dateTo, plansMap, buildingsMap, floorsMap, tasks, summary, photoMode, translations }: any) {
                ...
                <View style={styles.table}>
                    ...
                    <View style={styles.tableRow}>
                        ...
                        <View style={[styles.tableColHeader, { width: '15%' }]}>
                            <Text style={styles.tableCellHeader}>{t("company")}</Text>
                        </View>
                        <View style={[styles.tableColHeader, { width: '10%' }]}>
